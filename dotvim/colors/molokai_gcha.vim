...
" Spelling {{{
if has("spell")
    hi SpellBad    guibg=#0B9A17 guifg=#FFFFFF 
    hi SpellCap    guibg=#7070F0 guifg=yellow
    hi SpellLocal  guibg=#70F0F0 guifg=yellow
    hi SpellRare   guibg=#FFFFFF guifg=yellow
end " }}}
" Visual Mode {{{
